"""K Pro 2 laboratory L: transactional inventory and liquidation timing experiments.
...
def act_units(obs, st, work):
    ...
    for uid in workers:
        ...
        for p in tiles:
            ...
            urgency = min(CFG['urgency_cap'], value / CFG['urgency_divisor']) * (1.8 if hour >= 17 else 1.0)
