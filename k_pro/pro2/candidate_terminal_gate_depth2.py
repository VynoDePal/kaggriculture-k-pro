"""K Pro 2 terminal-gate-depth2 candidate: standalone deterministic public-observation policy.
Source SHA256: 736989b1109530088d7af1a5f582e7144f638290908a5398f91e2c95b4d4e4a8
Profile SHA256: 2d8823890af09c170e61fdbcdc09e3fd40d6d4c1a7a306407974de023ff24631
...
def decide(obs, st):
    if obs['day'] >= 22 and 'terminal_active' not in st:
        ...
        st['terminal_active'] = tree_decision(features, {'feature': 'wheat_forecast', 'threshold': 43.5, 'left': {'feature': 'own_strawberry', 'threshold': 27, 'left': True, 'right': False}, 'right': True})
