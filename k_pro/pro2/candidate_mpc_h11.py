"""K Pro 2 mpc-h11 candidate: standalone deterministic public-observation policy.
Source SHA256: 736989b1109530088d7af1a5f582e7144f638290908a5398f91e2c95b4d4e4a8
Profile SHA256: fb82a2466d1e258895704324e3c96ede14bdf468b4562a1973750fc8fdd62ac9
...
def plan(obs, st):
    ...
    hands = min(11, max(3, math.ceil(workload / 13)))
    if day == 0:
        hands = 6
    if day >= 28:
        hands = max(3, min(11, math.ceil(workload / 15)))
