"""candidate_marginal50_u500: standalone deterministic public-observation policy.
Source SHA256: 736989b1109530088d7af1a5f582e7144f638290908a5398f91e2c95b4d4e4a8
Profile SHA256: 5ceececfaa969285b6b2c9a32b6576983a1a6d7c7e7c98fe9bc91dcb627c3c8a
...
def act_units(obs, st, work):
    ...
    for uid in workers:
        ...
        for p in tiles:
            ...
            urgency = min(8, value / 500) * (1.8 if hour >= 17 else 1.0)
            zone_cost = 6
