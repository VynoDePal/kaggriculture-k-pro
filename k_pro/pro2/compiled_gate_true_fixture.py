"""K Pro 2 constant-gate compatibility fixture: standalone deterministic public-observation policy.
Source SHA256: b12c3f126d835d404c189e62d8abac8a5a6632e25b0d24bc137921b3606afbfc
Profile SHA256: 6fd6fb17cff85f4dd368e90cbeed194446fd6606cde327a943012f1fe0f83a77
...
def animal_tasks(t, day, prices, town):
    ...
    if useful_care and (not t.get('cared_today')) and (not skip) and (future_ticks > 0) and (prices[product] > prices['WHEAT'] * 0.5):
        acts.append(['CARE'])
...
def act_units_greedy(obs, st, work):
    ...
    for uid, pos in enumerate(positions):
        ...
        central_sale = back == 0 and cash_value >= (min(70, 200) if early_fert else 200) and (cash_item is not None)
...
def decide(obs, st):
    if obs['day'] >= 22 and 'terminal_active' not in st:
        ...
        st['terminal_active'] = tree_decision(features, True)
