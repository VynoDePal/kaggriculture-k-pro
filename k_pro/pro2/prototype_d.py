"""K Pro 2 laboratory D: transactional inventory and liquidation timing experiments.
        ...
        if money > 400 and animal_n < limit:
            ...
            for a, data in ANIMAL.items():
                ...
                if CFG['herd_policy'] in ('balanced', 'hybrid') and a in ('COW', 'SHEEP'):
                    ...
                    milk_share = max(CFG['milk_share_floor'], min(CFG['milk_share_ceiling'], 0.5 + 0.012 * (demand(town, 'MILK') - demand(town, 'WOOL')) - 0.02 * (rival.get('COW', 0) - rival.get('SHEEP', 0))))
...
def crop_tasks(t, day, prices):
    ...
    if c == 'WHEAT' and CFG['terminal_rotation'] and day >= CFG['rotation_harvest_day']:
