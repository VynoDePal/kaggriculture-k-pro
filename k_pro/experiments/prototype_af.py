...
CFG = dict(open_melons=12,open_sheep=2,open_cows=2,open_wheat=7,open_hands=5,max_hands=12,
           ...
           assignment_memory=.4,assignment_here=2.,hire_last_hour=8,lookahead_start_day=0,lookahead_replan_hours=(0,))
_STATE = {}
...
def act_units(obs,st,work):
    ...
    for uid in workers:
        ...
        for p in tiles:
            ...
            if pos[uid]==p:cost-=CFG['assignment_here']
            if previous_targets.get(uid)==p:cost-=CFG['assignment_memory']
