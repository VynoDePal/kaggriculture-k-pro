"""K Pro3 Capital C Cow and Melon: standalone deterministic public-observation policy.
Source SHA256: 8d3ff4c225526d26d1c9e84387bb000db296fdb142ec2551f55e2b61964108f5
Profile SHA256: d50359c946e9acb93aa684a234c3fc3b1b1b339b90083cf76d3ad6a6bfbfa9bb
...
def plan(obs, st):
    ...
    if day == 0:
        ...
        limit = min(18, 3 + 1 + max(0, day - 1) * 2)
    ...
    melon_target = 9 if day == 0 else ct.get('MELON', 0)
...
def assignment_urgency(value, hour, day):
    divisor = 250 if day < 10 else 500
