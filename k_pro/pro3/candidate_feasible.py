"""K Pro laboratory feasible-bundle: standalone deterministic public-observation policy.
Source SHA256: 8aaee6600ddd57cfe26f90a9ad00eef29a2f4342ea3eb3281c18cb1932259345
Profile SHA256: 65cbdefa2776ac4fabf90756f4be0006e202e6ac1968f298368d38c0e5542e01
...
def worker_task_value(tile, requested, feasible, value, day, prices):
    ...
    weight = 0.5
    if not weight or day < 6 or requested == feasible:
        return value
