"""K Pro 3 laboratory A: portable zoning and delayed urgency.
Parent N SHA256: 736989b1109530088d7af1a5f582e7144f638290908a5398f91e2c95b4d4e4a8
Experimental snapshot; no submission or performance claim.
"""
import math
import copy
...
CFG = {'workload_urgency': False, 'open_melons': 8, 'open_sheep': 4, 'open_cows': 0, 'open_wheat': 7, 'open_hands': 6, 'max_hands': 10, 'max_animals': 18, 'max_straw': 42, 'wheat_ratio': 0.65, 'land2_day': 6, 'land3_day': 10, 'land4_day': 12, 'four_quadrants': False, 'diamond_radius': 6, 'animal_radius': 2, 'fert_wheat': True, 'feed_roi': True, 'care': True, 'fert_collect_floor': 3, 'premium_floor': 0.05, 'forecast_days': 5, 'zone_penalty': 6, 'fert_stock': 12, 'crop_work': 1.7, 'animal_work': 4.8, 'work_per_hand': 13, 'late_wheat_day': 25, 'opportunistic_drop': 12, 'zone_mode': 'angular', 'harvest_wheat': 5, 'max_geese': 2, 'animal_forecast_weight': 0.35, 'land_buffer': 100, 'straw_start_day': 3, 'herd_policy': 'balanced', 'rival_value': 1.0, 'replan_hours': (4, 12), 'herd_batch': 2, 'capital_delivery': True, 'capital_value': 400, 'wheat_max': 24, 'planned_zones': True, 'protect_targets': False, 'reserve_herd_sites': 2, 'investment_reserve': 50, 'strict_diamond': True, 'scheduler': 'auction', 'delivery_last_day': 12, 'delivery_cash_ceiling': 4000, 'central_sale_value': 200, 'early_fert_delivery': False, 'finish_service': False, 'delivery_radius': 4, 'delivery_distance_cost': 50, 'crop_policy': 'legacy', 'crop_risk': 0.35, 'tomato_max': 24, 'carrot_max': 24, 'land_first': True, 'force_early_fert': False, 'hire_policy': 'legacy', 'route_hire_margin': 2, 'reserve_animal_ring': True, 'straw_forecast_floor': 20, 'full_day': True, 'pickup_extra_food': 0, 'herd_worker_effort': 5.0, 'herd_growth_rate': 2, 'feed_supply_fix': True, 'second_melons': 4, 'rotate_crops': False, 'react_land': True, 'straw_latest_day': 16, 'strict_species_cap': True, 'quota_balance_weight': 0.6, 'milk_share_floor': 0.3, 'milk_share_ceiling': 0.7, 'liquid_capital': False, 'idle_delivery': False, 'overflow_target': 90, 'economic_tasks': False, 'early_wheat_yield': 5, 'early_wheat_until': 4, 'open_carrots': 0, 'smart_fertilizer': False, 'buy_fertilizer': False, 'fertilizer_buy_ceiling': 20, 'final_bundle_fix': True, 'route_capacity': 21, 'route_balance': 0.03, 'route_future_service': True, 'late_zone_decay': False, 'capital_discount': 0.98, 'market_risk': 0.2, 'forecast_model': 'legacy', 'forecast_production': 1.7, 'future_shop_weight': 0.7, 'lookahead': True, 'lookahead_choices': 4, 'lookahead_field_weight': 0.15, 'seed_horizon_fix': True, 'care_cap': True, 'terminal_feed_roi': True, 'milk_shed_slots': True, 'market_delivery': False, 'market_delivery_value': 250, 'market_delivery_radius': 2, 'wheat_floor': None, 'rotation_scope': 'all', 'hybrid_weight': 0.5, 'feed_collapse_production': True, 'feed_task_budget': False, 'retire_unprofitable': False, 'retire_after': 24, 'market_rank': 'quote', 'bounded_market': False, 'critic_mode': 'realizable', 'tactic_set': 'logistics', 'lookahead_days': 2, 'goose_demand_min': 0, 'market_wheat': False, 'animal_labor_value': 0.0, 'stable_replans': False, 'hire_last_hour': 8, 'lookahead_start_day': 15, 'lookahead_replan_hours': (0,), 'post_unit_market': False, 'melon_delivery': False, 'melon_delivery_radius': 8, 'melon_delivery_until': 22, 'melon_delivery_threshold': 300, 'melon_pressure_threshold': 25, 'melon_task_boost': 1.0, 'carrot_start': 20, 'carrot_last': 26, 'carrot_cap': 20, 'melon_near': False, 'post_unit_start': 0, 'post_unit_end': 29, 'post_unit_mode': 'full', 'food_buffer': 0, 'hire_min_day': 0, 'terminal_rotation': False, 'rotation_start': 22, 'rotation_target': 36, 'rotation_last_plant': 26, 'rotation_harvest_day': 28, 'rotation_harvest_yield': 3, 'rotation_carrots': False, 'deadline_service': False, 'deadline_start_day': 0, 'fert_marginal': False, 'fert_action_cost': 0, 'terminal_allocate': False, 'terminal_total': 36, 'terminal_start': 22, 'terminal_last': 26, 'terminal_min_value': 5, 'herd_response': -0.02, 'herd_response_start': 1, 'terminal_gate': False, 'terminal_tree': None, 'specialist_start': 99, 'supply_batch': 0, 'fert_batch': 0, 'supply_start': 6, 'bundle_deposit': False, 'route_follow': False, 'route_follow_start': 6, 'route_follow_bonus': 20, 'land_escrow_days': 0, 'land_escrow_q': 3, 'land_escrow_fraction': 1, 'care_price_ratio': 0.5, 'care_forecast_days': 0, 'care_base_floor': 0, 'care_future_feeds': False, 'service_after': 99, 'late_central_start': 12, 'late_central_value': 200, 'lookahead_gate': False, 'lookahead_tree': None, 'task_value_weight': 0.0, 'task_value_start': 6, 'urgency_divisor': 250, 'urgency_cap': 8, 'service_length_cost': 0.15, 'portable_zones': False, 'urgency_start_day': 0, 'opening_urgency_divisor': 250}
_STATE = {}
...
def bounded_inventory(item, inventory):
    ...
    if not CFG['bounded_market'] or price(item, inventory) > 1:
        return inventory
...
def workload_pressure(work, positions, hour, day):
    """Bounded service-load proxy, not a route or supply-feasibility bound.

    Nearest-trip summation may double-count multi-stop travel and deliberately
    does not model carried supplies or future hires.
    """
    if (not CFG['workload_urgency'] or day < CFG['urgency_start_day'] or
            day >= 29 or not positions or not work):
        return 1.0
    effort = math.fsum(
        len(todo) + min(distance(position, tile) for position in positions)
        for tile, (todo, value) in sorted(work.items()) if todo
    )
    capacity = len(positions) * max(1, 24 - hour)
    return min(2.0, max(0.5, effort / capacity))
            ...
            for row in farm['tiles']:
                for t in row:
                    ...
                    if a and ANIMAL[a][4] == item:
                        _, first, interval, cap, _ = ANIMAL[a]
                    ...
                    if t.get('crop') == item:
                        ...
                        if interval:
                            ...
                            supply += max(t.get('yield_units', 0), cap * 0.85)
...
def herd_value(obs, species):
    ...
    """
    day = obs['day']
    item = ANIMAL[species][4]
    cost, first, interval, cap, _ = ANIMAL[species]
    town = obs.get('town', {})
    public = demand(town, item)
    gain = sum((6 * items.count(item) for items in SHOP.values())) / len(SHOP)
    seat = obs['player']
    counts_by_seat = [counts(f) for f in obs['farms']]
    own_n = counts_by_seat[seat].get(species, 0)
    rival_n = counts_by_seat[1 - seat].get(species, 0)
    candidates = []
    for optimism in (0.3, 1.0, 1.7):
        values = []
        for added in (0, 1):
            inventory = float(obs['market']['inventory'][item])
            cash = 0.0
            for d in range(day, 30):
                ...
                for s, farm in enumerate(obs['farms']):
                    ...
                    if s == seat:
                        ...
                        rival = quantity
                if added and d >= day + first:
                    own += (interval + 1) / interval
                growth = min(max(0, d - day), max(0, 10 - day)) * 0.18
                if d >= day + first:
                    rival += growth * (interval + 1) / interval
                total = own + rival
    ...
    return sum(candidates) / len(candidates) - 0.2 * (max(candidates) - min(candidates))

def crop_value(obs, crop, extra):
    """Marginal return per service action, including delayed and shared-market sales."""
    day = obs['day']
    seed, first, maximum, interval, cap = CROP[crop]
    ...
    town = obs.get('town', {})
    drain = demand(town, crop) * horizon
    gain = sum((6 * items.count(crop) for items in SHOP.values())) / len(SHOP)
    drain += sum((max(0, day + horizon - u) * gain * 0.7 for u in (3, 6, 9, 12, 15, 18, 21, 24) if u > day))
    pending = 0.0
    for farm in obs['farms']:
        for row in farm['tiles']:
            for t in row:
                if not isinstance(t, dict) or t.get('crop') != crop:
                    continue
                ...
                if interval:
                    ...
                    pending += max(t.get('yield_units', 0), cap * 0.8)
    expected = obs['market']['inventory'][crop] + pending + extra * amount - drain
    pessimistic = price(crop, int(expected + amount))
    optimistic = price(crop, int(expected + amount / 2 - drain * 0.3))
    effective = (1 - CFG['crop_risk']) * optimistic + CFG['crop_risk'] * pessimistic
    service = horizon * 0.55 + 3 + ticks + (2 if interval else 1) + horizon * 0.25
    return (effective * amount - seed) / (service * (1 + 0.025 * first))
...
def herd_value_exact(obs, species):
    ...
    day = obs['day']
    seat = obs['player']
    cost, first, interval, cap, item = ANIMAL[species]
    horizon = 30 - day
    flows = [[0.0] * horizon for _ in (0, 1)]
    for owner, farm in enumerate(obs['farms']):
        for row in farm['tiles']:
            for t in row:
                if not isinstance(t, dict) or t.get('animal') != species:
                    continue
                ...
                for offset in range(1, horizon):
                    d = day + offset
                    if d >= t['placed_day'] + first and (d - t['placed_day'] - first) % interval == 0:
                        flows[owner][offset] += min(cap, 1 + care)
                        care = 0
                    care += 1
    new = [0.0] * horizon
    care = 0
    ...
    fertilizer_sales = max(0, all_animals * 0.7 - 2)
    wheat_price = 0.6 * obs['market']['prices']['WHEAT'] + 0.4 * PARAMS['WHEAT'][0]
    scenarios = []
    for optimism in (0.3, 1.0, 1.7):
        values = []
        for added in (0, 1):
            ...
            for offset in range(horizon):
                d = day + offset
                own = flows[seat][offset] + added * new[offset]
                rival = flows[1 - seat][offset]
                total = own + rival
        ...
        for offset in range(horizon - 1):
            ...
            operating += CFG['capital_discount'] ** offset * (0.7 * fert - wheat_price)
...
def route_hands(obs, roles):
    ...
    for pos, (todo, _) in work.items():
        ...
        k = kind(tile)
        if k == 'EMPTY' and roles[pos] in ANIMAL:
            amount += 2
        if k in CROP and (not CROP[k][3]) and (['HARVEST'] in todo) and (day + CROP[k][1] < 29):
            amount += 2
        effort[pos] = amount
    if not effort:
        return 1
    ...
    for hands in range(2, CFG['max_hands'] + 1):
        units = hands + 1
        clusters = [[] for _ in range(units)]
        done = 0
        for pos in ordered:
            index = min(units - 1, int(done / total * units))
            clusters[index].append(pos)
            done += effort[pos] + 1
        times = []
        for points in clusters:
            ...
            if day == 29:
                duration += radius(here) + 1
            times.append(duration)
        if max(times) <= 24 - CFG['route_hire_margin'] and sum(times) <= units * 21:
            return hands
    return CFG['max_hands']

def terminal_features(obs):
    """Named economic features, strictly current public/own observation."""
    own = obs['farms'][obs['player']]
    rival = obs['farms'][1-obs['player']]
    ct = counts(own)
    rt = counts(rival)
    available = sum(kind(t) in ('EMPTY','WEED') and radius((x,y)) <= CFG['diamond_radius']
                    for y,row in enumerate(own['tiles']) for x,t in enumerate(row))
    return {
        'wheat_quote': obs['market']['prices']['WHEAT'],
        'carrot_quote': obs['market']['prices']['CARROT'],
        'wheat_forecast': forecast(obs,'WHEAT',3),
        'carrot_forecast': forecast(obs,'CARROT',3),
        'available_tiles': available,
        'own_wheat': ct.get('WHEAT',0),
        'own_strawberry': ct.get('STRAWBERRY',0),
        'own_animals': sum(ct.get(a,0) for a in ANIMAL),
        'rival_wheat': rt.get('WHEAT',0),
        'rival_strawberry': rt.get('STRAWBERRY',0),
        'rival_animals': sum(rt.get(a,0) for a in ANIMAL),
        'wheat_stock': obs['private']['shed'].get('WHEAT',0) + sum(i.get('WHEAT',0) for i in obs['private']['inventories']),
    }


def tree_decision(features, node):
...
def plan(obs, st):
    ...
    if CFG['liquid_capital']:
        for item in PARAMS:
            if item == 'WHEAT':
                continue
            if item == 'FERTILIZER' and (day >= 9 or p[item] < p['WHEAT'] * 1.5):
                continue
            floor = max(1, int(PARAMS[item][0] * CFG['premium_floor']))
            if p[item] >= floor:
                money += sum((max(0, price(item, obs['market']['inventory'][item] + i)) for i in range(priv['shed'].get(item, 0))))
    ...
    if day == 0:
        targets['SHEEP'] = CFG['open_sheep']
        targets['COW'] = CFG['open_cows']
    elif day <= 16:
        ...
        if money > 400 and animal_n < limit:
            ...
            for a, data in ANIMAL.items():
                if a == 'GOOSE' and ct.get(a, 0) + pending[a] >= CFG['max_geese']:
                    continue
                if a == 'GOOSE' and demand(town, 'EGG') < CFG['goose_demand_min']:
                    continue
                if a == 'GOOSE':
                    species_room[a] = CFG['max_geese'] - ct.get(a, 0) - pending[a]
                if CFG['herd_policy'] in ('balanced', 'hybrid') and a in ('COW', 'SHEEP'):
                    rival = counts(obs['farms'][1 - obs['player']])
                    milk_share = max(CFG['milk_share_floor'], min(CFG['milk_share_ceiling'], 0.5 + 0.012 * (demand(town, 'MILK') - demand(town, 'WOOL')) + (CFG['herd_response'] if day >= CFG['herd_response_start'] else -0.02) * (rival.get('COW', 0) - rival.get('SHEEP', 0))))
                ...
                net = herd_value_exact(obs, a) if CFG['herd_policy'] == 'margin_exact' else herd_value(obs, a) if CFG['herd_policy'] == 'margin' else ticks * (interval + 1) * fp + (29 - day) * min(15, p['FERTILIZER']) - (29 - day) * p['WHEAT'] - cost
                if CFG['herd_policy'] == 'hybrid':
                    net = (1 - CFG['hybrid_weight']) * net + CFG['hybrid_weight'] * herd_value_exact(obs, a)
                net -= (29 - day) * (2 + 1 / interval) * CFG['animal_labor_value']
                if CFG['herd_policy'] in ('balanced', 'hybrid') and a in ('COW', 'SHEEP'):
                    fullness = (ct.get(a, 0) + pending[a]) / max(1, math.ceil(CFG['max_animals'] * share))
                    net *= max(0.1, 1 - CFG['quota_balance_weight'] * fullness)
                choices.append((net / max(1, cost), a))
            if choices:
                value, a = max(choices)
                if value > 1.0:
                    targets[a] += min(CFG['herd_batch'], limit - animal_n, species_room[a] if CFG['strict_species_cap'] else limit - animal_n)
    pending = {a: priv['shed'].get(a, 0) + sum((i.get(a, 0) for i in priv['inventories'])) for a in ANIMAL}
    for a in ANIMAL:
    ...
    if (CFG['terminal_rotation'] or st.get('terminal_active',False)) and CFG['rotation_start'] <= day <= CFG['rotation_last_plant']:
        wheat_target = max(wheat_target, CFG['rotation_target'])
    if CFG['market_wheat'] and 4 <= day <= CFG['late_wheat_day']:
        ratio = max(0.7, min(1.7, (forecast(obs, 'WHEAT', 4) / PARAMS['WHEAT'][0]) ** 0.5))
        wheat_target = min(CFG['wheat_max'], max(wheat_floor, math.ceil(wheat_target * ratio)))
    straw_target = 0 if day < CFG['straw_start_day'] else min(CFG['max_straw'], 2 + day * 3)
    if day > CFG['straw_latest_day']:
        straw_target = ct.get('STRAWBERRY', 0)
    if day >= 3 and forecast(obs, 'STRAWBERRY', 8) < CFG['straw_forecast_floor']:
    ...
    if 11 <= day <= 18 and forecast(obs, 'MELON', 10) > 100:
        melon_target = max(melon_target, CFG['second_melons'])
    carrot_target = CFG['open_carrots'] if day == 0 else 0
    if CFG['carrot_start'] <= day <= CFG['carrot_last'] and p['CARROT'] > 35:
        carrot_target = min(CFG['carrot_cap'], 8 + int(demand(town, 'CARROT') / 2))
    if (CFG['terminal_rotation'] or st.get('terminal_active',False)) and day >= CFG['rotation_start'] and not CFG['rotation_carrots']:
        carrot_target = 0
    wanted = {'WHEAT': wheat_target, 'STRAWBERRY': straw_target, 'MELON': melon_target, 'CARROT': carrot_target}
    if CFG['terminal_allocate'] and CFG['terminal_start'] <= day <= CFG['terminal_last']:
        # Allocate only NEW short-cycle crops. Existing animals/perennials remain
        # serviced; predicted quotes are derived solely from public observations.
        wanted['WHEAT'] = max(ct.get('WHEAT', 0), wheat_target)
        wanted['CARROT'] = ct.get('CARROT', 0)
        future_prices = {c: forecast(obs, c, min(3, 29-day)) for c in ('WHEAT', 'CARROT')}
        for _ in range(max(0, CFG['terminal_total'] - wanted['WHEAT'] - wanted['CARROT'])):
            choices = []
            for c in ('WHEAT', 'CARROT'):
                yield_units = (5 if day <= 25 else 3) if c == 'WHEAT' else 3
                added = max(0, wanted[c] - ct.get(c, 0))
                public_inventory = obs['market']['inventory'][c]
                impact = price(c, public_inventory + added * yield_units) - p[c]
                quote = max(1, future_prices[c] + impact)
                effort = 6 if c == 'WHEAT' else 5
                value = (yield_units * quote - CROP[c][0]) / effort
                choices.append((value, c))
            value, crop = max(choices)
            if value < CFG['terminal_min_value']:
                break
            wanted[crop] += 1
    if CFG['crop_policy'] == 'marginal' and day > 0:
        wanted = {c: ct.get(c, 0) for c in CROP}
        wanted['WHEAT'] = max(wanted['WHEAT'], wheat_target)
        cap_by_crop = {'WHEAT': CFG['wheat_max'], 'STRAWBERRY': CFG['max_straw'], 'TOMATO': CFG['tomato_max'], 'CARROT': CFG['carrot_max'], 'MELON': 18}
        ...
        for _ in range(max(0, total_cap - sum(wanted.values()))):
            options = []
            for c in CROP:
                if wanted[c] >= cap_by_crop[c]:
                    continue
                if c == 'WHEAT' and day > CFG['late_wheat_day']:
                    continue
    ...
    for c in ('MELON', 'WHEAT', 'STRAWBERRY', 'TOMATO', 'CARROT'):
        for _ in range(max(0, wanted.get(c, 0) - ct.get(c, 0))):
            ...
            if not allowed:
                break
            slot = min(allowed, key=lambda pos: (-radius(pos) if c == 'MELON' and day < 2 and not CFG['melon_near'] else radius(pos), pos))
            roles[slot] = c
            free.remove(slot)
    ...
    if day == 0:
        hands = CFG['open_hands']
    if day >= 28:
        hands = max(3, min(CFG['max_hands'], math.ceil(workload / 15)))
...
def crop_tasks(t, day, prices, rotation_active=False):
    ...
    if c == 'WHEAT' and (CFG['terminal_rotation'] or CFG['terminal_allocate'] or rotation_active) and day >= CFG['rotation_harvest_day']:
        wheat_harvest = min(wheat_harvest, CFG['rotation_harvest_yield'])
    ...
    if day < 29 or ready or (not interval and age >= first and (yu > 0)):
        ...
        if CFG['smart_fertilizer']:
            ...
            if wants_fert and extra * prices[c] > max(5, prices['FERTILIZER']):
                acts.append(['FERTILIZE'])
        elif wants_fert and prices[c] * 2 > max(8, prices['FERTILIZER']):
            acts.append(['FERTILIZE'])
        if not t.get('watered_today') and (growing or (dying and (not ready))):
            acts.append(['WATER'])
    if ready:
        acts.append(['HARVEST'])
    if CFG['fert_marginal'] and ['FERTILIZE'] in acts:
        if interval:
            future_windows = sum(day <= t['planted_day'] + first + i * interval - 1 <= min(day + 2, 28) for i in range(cap))
            extra = min(max(0, cap - yu), future_windows)
        else:
            extra = max(0, min(2, cap - yu) - min(1, cap - yu))
            if not ready:
                extra += max(0, min(2, maximum - day + t['planted_day']))
        if extra * prices[c] <= prices['FERTILIZER'] + CFG['fert_action_cost']:
            acts.remove(['FERTILIZE'])
    value = (prices[c] * max(1, yu) + seed * 0.5) * (CFG['melon_task_boost'] if c == 'MELON' and age >= first else 1)
    urgent = 1000 if dying and (not ready) and (day < 29) else 0
    return (acts, value + urgent)

def fit_service(tile, sequence, day, slots):
    """Retain a feasible same-day subset, without mutating the source contract.

    Only applied when the complete bundle cannot fit. Survival first; otherwise
    retain harvest and water before optional care/fertilizer collection.
    Fertilization without a remaining water action is deliberately deferred.
    """
    if slots <= 0:
        return []
    ...
    # A new plant starts with one unwatered day and dies at tonight's refresh
    # unless its mandatory first WATER can also execute.
    if 'PLANT' in ops and slots < 2:
        return []
    starving = isinstance(tile, dict) and tile.get('animal') and tile.get('consecutive_unfed', 0)
    drying = isinstance(tile, dict) and tile.get('crop') and tile.get('consecutive_unwatered', 0)
    ranked = []
    for i, action in enumerate(sequence):
        op = action[0]
        if op == 'FERTILIZE':
            continue
        rank = {'HARVEST': 2, 'FEED': 3, 'WATER': 4, 'CARE': 5,
                'COLLECT_FERTILIZER': 6}.get(op, 4)
        if op == 'FEED' and starving:
            rank = 0
        if op == 'WATER' and drying and ('HARVEST' not in ops or CROP[tile['crop']][3]):
            rank = 1
        ranked.append((rank, i))
    chosen = {i for _, i in sorted(ranked)[:slots]}
    return [a for i, a in enumerate(sequence) if i in chosen]
...
def animal_tasks(t, day, prices, town, care_quotes=None):
    ...
    care_quote = max(care_quote, PARAMS[product][0] * CFG['care_base_floor'])
    if CFG['care_future_feeds'] and care_quote > prices['WHEAT'] and t.get('pending_care_bonus',0) < cap - 1:
        skip = False
    ...
    if CFG['care'] and useful_care and (not t.get('cared_today')) and (not skip) and (future_ticks > 0) and (care_quote > prices['WHEAT'] * CFG['care_price_ratio']):
        acts.append(['CARE'])
    if t.get('fertilizer_available') and prices['FERTILIZER'] >= CFG['fert_collect_floor']:
...
def incremental_task_value(tile, sequence, day, prices):
    ...
    if k in CROP:
        ...
        growing = ((maximum + 1)//2 <= age <= maximum and units < cap
                   if not interval else age + 1 >= first and
                   (age + 1-first)%interval == 0 and (age+1-first)//interval < cap)
        if 'HARVEST' in ops:
...
def tasks(obs, st):
    ...
    result = {}
    care_quotes = None
    if CFG['care_forecast_days']:
        care_quotes = {product:max(prices[product],forecast(obs,product,CFG['care_forecast_days'])) for product in ('MILK','WOOL','EGG')}
    for pos, role in st['roles'].items():
        ...
        if k in CROP:
            ...
            acts, value = ([], 0)
        if acts:
            if CFG['task_value_weight'] and day >= CFG['task_value_start']:
                marginal = incremental_task_value(t, acts, day, prices)
                if marginal is not None:
                    value = (1-CFG['task_value_weight'])*value + CFG['task_value_weight']*marginal
            result[pos] = (acts, value)
    return result

def zone_total(values):
    return math.fsum(values) if CFG['portable_zones'] else sum(values)


def assignment_urgency(value, hour, day, pressure=1.0):
    divisor = CFG['opening_urgency_divisor'] if day < CFG['urgency_start_day'] else CFG['urgency_divisor']
    return min(CFG['urgency_cap'], value * pressure / divisor) * (1.8 if hour >= 17 else 1.0)


def zones(st, work, n):
    zone_mode = 'specialized' if st['day'] >= CFG['specialist_start'] else CFG['zone_mode']
    if CFG['route_follow'] and st['day'] >= CFG['route_follow_start']:
        zone_mode = 'routing'
    ...
    if zone_mode == 'routing':
        ...
        for pos in sorted(work, key=lambda p: (-radius(p), -len(work[p][0]), p)):
            ...
            if CFG['route_future_service'] and st['roles'][pos] in ANIMAL and any((a[0] in ('PLACE', 'BUILD_PASTURE', 'BUILD_COOP') for a in work[pos][0])):
                service += 2
            best = None
            for uid, route in enumerate(routes):
                for j in range(len(route) + 1):
                    ...
                    cost = delta + CFG['route_balance'] * duration[uid] + 0.8 * max(0, duration[uid] + delta - CFG['route_capacity']) ** 2
...
def act_units_greedy(obs, st, work):
    ...
    for uid, pos in enumerate(positions):
        ...
        service_pending = (CFG['finish_service'] or CFG['market_delivery'] or day >= CFG['service_after']) and any((a[0] == 'WATER' and kind(standing) in CROP or (a[0] == 'FEED' and inv.get('WHEAT', 0) > 0) or (a[0] == 'CARE' and isinstance(standing, dict) and standing.get('fed_today')) for a in work.get(pos, ([], 0))[0]))
        central_sale = back == 0 and cash_value >= (min(70, CFG['central_sale_value']) if early_fert else (CFG['late_central_value'] if day >= CFG['late_central_start'] else CFG['central_sale_value'])) and (cash_item is not None)
        ...
        if CFG['market_delivery'] and cash_item and (hour < 21) and (back <= CFG['market_delivery_radius']) and (cash_value / (back + 1) >= CFG['market_delivery_value']) and (obs['market']['prices'][cash_item] >= PARAMS[cash_item][0] * 0.5):
            deliver = True
        if CFG['melon_delivery'] and cash_item == 'MELON' and hour < CFG['melon_delivery_until'] and back <= CFG['melon_delivery_radius'] and hour + back + 1 <= 24:
            if st.get('_delivery_step') != obs['step']:
                st['_delivery_step'] = obs['step']
                st['_melon_forecast'] = forecast(obs, 'MELON', 1)
            pressure = max(0, obs['market']['prices']['MELON'] - st['_melon_forecast'])
            if cash_value >= CFG['melon_delivery_threshold'] and (CFG['melon_delivery'] == 'always' or inv['MELON'] * pressure >= CFG['melon_pressure_threshold'] * (back + 1)):
                deliver = True
        ...
        if cash_item and (not service_pending) and deliver:
            if back:
                ...
                fixed.add(uid)
                continue
            if CFG['bundle_deposit'] and not inv.get('WHEAT') and all(item in PARAMS for item in inv) and sum(n > 0 for n in inv.values()) > 1 and sum(inv.values()) <= 100 - sum(shed.values()):
                actions.append(['DROP'])
                for item, count in inv.items():
        ...
        if feed_need:
            feed_need += CFG['pickup_extra_food']
        ...
        if back == 0:
            ...
            for item, need in [('WHEAT', feed_need), ('FERTILIZER', min(5, fert_need))]:
                if day >= CFG['supply_start'] and need:
                    batch = CFG['supply_batch'] if item == 'WHEAT' else CFG['fert_batch']
                    if batch:
        ...
        for p, (todo, value) in work.items():
            ...
            for a in todo:
                ...
                sequence.append(a)
            d = distance(pos, p)
            if CFG['deadline_service'] and CFG['deadline_start_day'] <= day < 29:
                sequence = fit_service(me['tiles'][p[1]][p[0]], sequence, day, 24 - hour - d)
            if not sequence:
                ...
                if hour + d + 1 + (radius(p) + 1 if day == 29 else 0) > deadline:
                    continue
                score = d + CFG['zone_penalty'] * (z.get(p) != uid) - min(3.0, value / 600)
...
def act_units(obs, st, work):
    ...
    pressure = workload_pressure(work, pos, hour, day)
    ...
    for uid in workers:
        ...
        for p in tiles:
            ...
            deadline = (23 if day == 29 else 24) if CFG['full_day'] else 22 if day == 29 else 23
            if CFG['deadline_service'] and CFG['deadline_start_day'] <= day < 29:
                valid = fit_service(me['tiles'][p[1]][p[0]], valid, day, 24 - hour - d)
            ...
            urgency = assignment_urgency(value, hour, obs['day'], pressure)
            zone_cost = CFG['zone_penalty']
            if CFG['late_zone_decay']:
                zone_cost *= max(0.0, 1 - max(0, hour - 10) / 13)
            cost = d + CFG['service_length_cost'] * len(valid) - urgency + zone_cost * (st['zones'].get(p) != uid)
            if pos[uid] == p:
                cost -= 2
            ...
            row.append(cost)
            cmd.append(action)
        if CFG['route_follow'] and day >= CFG['route_follow_start'] and uid < len(st.get('planned_routes', [])):
            by_tile = {p:i for i,p in enumerate(tiles)}
            for target in st['planned_routes'][uid]:
                j = by_tile.get(target)
                if j is not None and row[j] < 100000:
                    row[j] -= CFG['route_follow_bonus']
                    break
...
def idle_deliveries(obs, actions, shed):
    ...
    for uid, pos in enumerate(positions):
        if actions[uid] != ['PASS']:
            continue
        nearest = min(SHED, key=lambda p: distance(pos, p))
        back = distance(pos, nearest)
        if hour + back + 1 > 24:
            continue
        inv = invs[uid]
        ...
        qty = inv[item]
        if obs['market']['prices'][item] * qty < 30:
            continue
    ...
    for _, uid, item, qty, nearest, back in sorted(choices):
        if excess <= 0:
            break
        if back:
            actions[uid] = move(positions[uid], nearest)
        else:
            qty = min(qty, max(0, 100 - sum(shed.values())))
            if not qty:
                continue
            actions[uid] = ['PLACE', item, qty]
...
def market_orders(obs, st, shed):
    ...
    elif CFG['market_rank'] == 'revenue':
        items = sorted(PARAMS, key=lambda p: (-prices[p] * shed.get(p, 0), p))
    for item in items:
    ...
    while current < st['hands'] and hour < CFG['hire_last_hour']:
    ...
    if CFG['food_buffer']:
        target_food = unfed + sum(st['herd'].values()) // 3 if final_feeds is None else final_feeds
        wheat_need = max(0, target_food + CFG['food_buffer'] - shed.get('WHEAT', 0) - carry['WHEAT'])
    ...
    if CFG['buy_fertilizer'] and hour < 19 and (prices['FERTILIZER'] <= CFG['fertilizer_buy_ceiling']):
        ...
        while qty and (sum((price('FERTILIZER', mi['FERTILIZER'] - i - 1) for i in range(qty))) > money - 100 or sum(shed.values()) + qty > 90):
            qty -= 1
        if qty:
            append(['BUY_PRODUCT', 'FERTILIZER', qty], sum((price('FERTILIZER', mi['FERTILIZER'] - i - 1) for i in range(qty))))
    reserve = CFG['investment_reserve'] + max(0, herd - priv['shed'].get('WHEAT', 0) - carry['WHEAT']) * prices['WHEAT']
    q = len(me['unlocked_quadrants'])
    land_day = CFG['land2_day'] if q == 1 else CFG['land3_day'] if q == 2 else CFG['land4_day']
    ...
    if CFG['land_first']:
        acquire_land()
    escrow = 0
    if CFG['land_escrow_days'] and q < CFG['land_escrow_q'] and day >= land_day - CFG['land_escrow_days'] and day <= 16 and (q < 3 or CFG['four_quadrants']) and not any(o[0] == 'BUY_LAND' for o in orders):
        escrow = land_cost * CFG['land_escrow_fraction']
    for a, data in ANIMAL.items():
    ...
    for crop, data in CROP.items():
        if CFG['seed_horizon_fix'] and day + data[1] >= 30:
            continue
        needed = sum((role == crop and kind(me['tiles'][p[1]][p[0]]) in ('EMPTY', 'WEED') and (not CFG['strict_diamond'] or len(me['unlocked_quadrants']) < 3 or radius(p) <= CFG['diamond_radius']) for p, role in st['roles'].items())) - priv['seeds'].get(crop, 0)
...
def decide(obs, st):
    if CFG['terminal_gate'] and obs['day'] >= CFG['rotation_start'] and 'terminal_active' not in st:
        features = terminal_features(obs)
        st['terminal_active'] = tree_decision(features, CFG['terminal_tree'])
        st['terminal_gate_features'] = features
    player = obs['player']
    ...
    if st['day'] != obs['day'] or structural or (obs['hour'] in CFG['replan_hours'] and obs['farms'][player]['money'] > 400):
        ...
        stable = CFG['stable_replans'] and st.get('day') == obs['day'] and (st.get('quadrants') == len(obs['farms'][player]['unlocked_quadrants'])) and st.get('zones')
        plan(obs, st)
        if keep_routes:
            st.update(previous)
    ...
    if CFG['post_unit_market'] and CFG['post_unit_start'] <= obs['day'] <= CFG['post_unit_end']:
        projected = project_unit_phase(obs, actions)
        if CFG['post_unit_mode'] == 'carry':
            market_obs = dict(obs)
            market_obs['private'] = dict(obs['private'])
            market_obs['private']['inventories'] = [dict(inv) for inv in obs['private']['inventories']]
            for inv, post in zip(market_obs['private']['inventories'], projected['private']['inventories']):
                for product in PARAMS:
                    inv.pop(product, None)
                    if post.get(product, 0):
                        inv[product] = post[product]
            orders = market_orders(market_obs, st, shed)
        else:
            orders = market_orders(projected, st, dict(projected['private']['shed']))
    else:
    ...
    if CFG['rotate_crops']:
        ...
        for pos, action in zip(positions, actions):
            ...
            if action[0] == 'HARVEST' and kind(tile) in CROP and (not CROP[kind(tile)][3]) and (CFG['rotation_scope'] == 'all' or kind(tile) == CFG['rotation_scope']):
                st['rotation_pending'] = True
    st['last_step'] = step
    return {'farmer': actions[0], 'hands': actions[1:], 'market': orders}

def project_unit_phase(obs, actions):
    """Project only our already selected actions; no opponent-private inputs."""
    result = dict(obs)
    result['private'] = {'shed': dict(obs['private']['shed']),
                         'seeds': dict(obs['private']['seeds']),
                         'inventories': [dict(i) for i in obs['private']['inventories']]}
    ...
    farm['tiles'] = [[dict(t) if isinstance(t, dict) else t for t in row] for row in farm['tiles']]
    result['farms'][obs['player']] = farm
    shadow_step(result, {'farmer': actions[0], 'hands': actions[1:]}, units_only=True)
    return result


def shadow_step(obs, action, units_only=False):
    ...
    for a in acts:
        if a[0] == 'PLANT':
            planting[a[1]] = planting.get(a[1], 0) + 1
    ...
    for uid, (pos, inv, a) in enumerate(zip(positions, inventories, acts)):
        ...
        if op == 'PICKUP' and at_shed:
            item = a[1]
            n = min(a[2] if len(a) > 2 else 1, shed.get(item, 0))
            if n > 0:
                shed[item] -= n
                add(item, n)
            continue
        if op == 'PLACE':
            ...
            if item in ANIMAL and kind(tile) == structure:
                if take(item):
                    tiles[y][x] = {'kind': structure, 'animal': item, 'placed_day': day, 'yield_units': 0, 'consecutive_unfed': 0, 'fed_today': False, 'cared_today': False, 'fertilizer_available': False, 'pending_care_bonus': 0}
            elif at_shed:
        ...
        if tile == 'LOCKED':
            continue
        if op == 'DIG' and kind(tile) not in ANIMAL:
            tiles[y][x] = None
            ...
            c = tile['crop']
            _, _, maximum, interval, cap = CROP[c]
            age = day - tile['planted_day']
            if not interval and (maximum + 1) // 2 <= age <= maximum:
                tile['yield_units'] = min(cap, tile['yield_units'] + (2 if tile['fertilized_until_day'] >= day else 1))
        elif op == 'FERTILIZE' and kind(tile) in CROP and take('FERTILIZER'):
            tile['fertilized_until_day'] = max(tile['fertilized_until_day'], day + 2)
        elif op == 'HARVEST' and isinstance(tile, dict) and (tile.get('yield_units', 0) > 0):
            c = tile.get('crop')
            a_kind = tile.get('animal')
            if c and day - tile['planted_day'] >= CROP[c][1]:
                add(c, tile['yield_units'])
                tile['yield_units'] = 0
                if not CROP[c][3]:
                    tiles[y][x] = None
            elif a_kind:
                add(ANIMAL[a_kind][4], tile['yield_units'])
                tile['yield_units'] = 0
        elif kind(tile) in ANIMAL:
            if op == 'FEED' and (not tile['fed_today']) and take('WHEAT'):
                tile['fed_today'] = True
            elif op == 'CARE':
                tile['cared_today'] = True
            elif op == 'COLLECT_FERTILIZER' and tile['fertilizer_available']:
    ...
    for order in action.get('market', [])[:10]:
        ...
        if op == 'HIRE':
            ...
            if farm['money'] >= cost:
                ...
                farm['hands'].append(list(spawn))
                inventories.append({})
        elif op == 'BUY_LAND':
            q = len(farm['unlocked_quadrants'])
            if q < 4 and farm['money'] >= (1000, 2000, 4000)[q - 1]:
                farm['money'] -= (1000, 2000, 4000)[q - 1]
                quadrant = ('NE', 'SW', 'SE')[q - 1]
                farm['unlocked_quadrants'].append(quadrant)
                for y in range(10):
                    for x in range(10):
                        if ('N' if y < 5 else 'S') + ('W' if x < 5 else 'E') == quadrant and tiles[y][x] == 'LOCKED':
                            tiles[y][x] = None
        elif len(order) >= 3:
            item = order[1]
            for _ in range(order[2]):
                if op == 'SELL' and item in PARAMS and shed.get(item, 0):
                    quote = price(item, market[item])
                    farm['money'] += quote
                    shed[item] -= 1
                    if quote > 1:
                        market[item] += 1
                    ...
                    if farm['money'] < quote or (op != 'BUY_SEED' and sum(shed.values()) >= 100):
                        break
                    farm['money'] -= quote
                    if op == 'BUY_SEED':
            ...
            for x, t in enumerate(row):
                ...
                if k in CROP:
                    ...
                    if t['consecutive_unwatered'] >= 2:
                        tiles[y][x] = {'kind': 'WEED'}
                        continue
                    _, first, _, interval, cap = CROP[k]
                    elapsed = day + 1 - t['planted_day'] - first
                    if interval and elapsed >= 0 and (elapsed % interval == 0) and (elapsed // interval < cap):
                        ...
                        if elapsed // interval == cap - 1:
                            t['max_lifespan_step'] = (day + 2) * 24
                elif k in ANIMAL:
                    t['consecutive_unfed'] = 0 if t['fed_today'] else t['consecutive_unfed'] + 1
                    if t['consecutive_unfed'] >= 2:
                        tiles[y][x] = {'kind': 'COOP' if k == 'GOOSE' else 'PASTURE'}
                        continue
                    _, first, interval, cap, _ = ANIMAL[k]
                    elapsed = day + 1 - t['placed_day'] - first
                    if elapsed >= 0 and elapsed % interval == 0:
                        t['yield_units'] = min(cap, t['yield_units'] + 1 + (t.get('pending_care_bonus', 0) if t['fed_today'] else 0))
...
def shadow_value(obs):
    ...
    field_goods = {}
    if CFG['critic_mode'] == 'realizable':
        for row in farm['tiles']:
            for tile in row:
                k = kind(tile)
                if k in ANIMAL:
                    item = ANIMAL[k][4]
                elif k in CROP and day - tile['planted_day'] >= CROP[k][1]:
                    item = k
                else:
                    continue
                field_goods[item] = field_goods.get(item, 0) + tile.get('yield_units', 0)
        for item, n in field_goods.items():
            goods[item] = goods.get(item, 0) + n
    for item, n in goods.items():
        if item in PARAMS:
            value += sum((price(item, obs['market']['inventory'][item] + j) for j in range(n)))
        elif item in ANIMAL:
            value += n * ANIMAL[item][0]
    value += sum((priv['seeds'].get(c, 0) * CROP[c][0] for c in CROP))
    if day < 19:
        value += (0, 1000, 3000, 7000)[len(farm['unlocked_quadrants']) - 1]
    for row in farm['tiles']:
        for tile in row:
            k = kind(tile)
            if k in ANIMAL:
                cost, first, interval, cap, product = ANIMAL[k]
                quote = 0.6 * prices[product] + 0.4 * PARAMS[product][0]
                if CFG['critic_mode'] == 'realizable':
                    quote = (prices[product] + forecast(obs, product, interval)) / 2
                ticks = max(0, (29 - tile['placed_day'] - first) // interval - (day - tile['placed_day'] - first) // interval)
                if CFG['critic_mode'] != 'realizable':
                    value += tile.get('yield_units', 0) * quote
                value += min(cap - 1, tile.get('pending_care_bonus', 0)) * quote * 0.85
                value += CFG['lookahead_field_weight'] * (cost * 0.5 + ticks * (interval + 1) * quote)
            elif k in CROP:
                seed, first, maximum, interval, cap = CROP[k]
                quote = 0.6 * prices[k] + 0.4 * PARAMS[k][0]
                if CFG['critic_mode'] == 'realizable':
                    quote = (prices[k] + forecast(obs, k, max(1, tile['planted_day'] + first - day))) / 2
                if CFG['critic_mode'] != 'realizable' or day - tile['planted_day'] < first:
                    value += tile.get('yield_units', 0) * quote
                if interval:
...
def choose_tactics(obs, st):
    choices = [{}, {'zone_penalty': 3.0}, {'zone_penalty': 9.0}, {'pickup_extra_food': 1}, {'zone_mode': 'routing'}, {'zone_penalty': 0.0}, {'pickup_extra_food': 2}][:CFG['lookahead_choices']]
    if CFG['tactic_set'] == 'economic':
        choices = [{}, {'zone_penalty': 3.0}, {'zone_penalty': 9.0}, {'pickup_extra_food': 1}, {'capital_delivery': False}, {'market_delivery': True, 'market_delivery_value': 400}, {'smart_fertilizer': True, 'buy_fertilizer': True, 'fertilizer_buy_ceiling': 20}][:CFG['lookahead_choices']]
    elif CFG['tactic_set'] == 'terminal':
        choices = [{}] + [{'zone_penalty': v} for v in (0.0, 2.0, 4.0, 8.0, 10.0, 12.0)]
    original = dict(CFG)
    results = []
    try:
        for patch in choices:
            ...
            memory = copy.deepcopy(st)
            remaining = min(24 * CFG['lookahead_days'] - obs['hour'], 719 - obs['step'])
            for _ in range(remaining):
                shadow_step(world, decide(world, memory))
...
def agent(obs, configuration=None):
    ...
    if player not in _STATE or step <= _STATE[player].get('last_step', -1):
        _STATE[player] = {'day': -1}
    st = _STATE[player]
    if CFG['lookahead_gate'] and obs['day'] >= CFG['lookahead_start_day'] and 'use_lookahead' not in st:
        features = terminal_features(obs)
        st['use_lookahead'] = tree_decision(features, CFG['lookahead_tree'])
        st['lookahead_gate_features'] = features
    if not CFG['lookahead'] or obs['day'] < CFG['lookahead_start_day'] or (CFG['lookahead_gate'] and not st.get('use_lookahead',False)):
        return decide(obs, st)
    if st.get('tactics_day') != obs['day'] or (obs['hour'] in CFG['lookahead_replan_hours'] and st.get('tactics_step') != step):
        st['tactics'] = choose_tactics(obs, st)
        st['tactics_day'] = obs['day']
        st['tactics_step'] = step
    original = dict(CFG)
    try:
        CFG.update(st.get('tactics', {}))
        return decide(obs, st)
    finally:
        CFG.clear()
        CFG.update(original)
