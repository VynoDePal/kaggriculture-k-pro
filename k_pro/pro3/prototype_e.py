    ...
    for pos, role in st['roles'].items():
        ...
        if acts:
            if CFG['task_value_weight'] and day >= CFG['task_value_start']:
                if CFG['task_care_forecast'] and k in ANIMAL and ['CARE'] in acts:
