"""K Pro 3 TOMATO N cap 4: standalone deterministic public-observation policy.
Source SHA256: a883cedd600db18203e710a7916addca2580acdf5eecba70040a4f6ccd4ecee2
Profile SHA256: c19a454aa1168fd46592951a47dee560c3f2eb51c0b27a9cf2754e97cfbb43da
...
def plan(obs, st):
    ...
    if day < 20 and 4 * p['TOMATO'] >= 5 * PARAMS['TOMATO'][0]:
        tomato_target = max(tomato_target, 4)
