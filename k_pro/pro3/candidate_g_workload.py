"""K Pro 3 workload G: standalone deterministic public-observation policy.
Source SHA256: f9076a2d084630fd723568b2990109e6f0071c1c69b090ca8ae74198ce35a5f3
Profile SHA256: 8f494bd7682ad92843580551e7213f58515c4e5312c57c5bb3f005999e03cee1
...
def workload_pressure(work, positions, hour, day):
    ...
    """
    if day < 6 or day >= 29 or (not positions) or (not work):
        return 1.0
    effort = math.fsum((len(todo) + min((distance(position, tile) for position in positions)) for tile, (todo, value) in sorted(work.items()) if todo))
...
def assignment_urgency(value, hour, day, pressure=1.0):
    ...
    return min(8, value * pressure / divisor) * (1.8 if hour >= 17 else 1.0)
