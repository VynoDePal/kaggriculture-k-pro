...
import math
import copy
CFG = {'early_melon_delivery': False, 'idle_overflow_delivery': False, 'project_market': False, 'wheat_autonomy': False, 'melon_replant_roi': False, 'fourth_quadrant': False, 'near_opening_melons': True}
