...
import math
import copy
from k_pro.pro4.economy import wheat_acreage_target, late_melon_plant_count, fourth_quadrant_eligible
from k_pro.pro4.projection import project_unit_phase
CFG = {'early_melon_delivery': True, 'idle_overflow_delivery': True,
       'project_market': False, 'wheat_autonomy': False,
       'melon_replant_roi': False, 'fourth_quadrant': False,
       'near_opening_melons': False}
